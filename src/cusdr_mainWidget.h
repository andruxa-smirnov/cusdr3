...
private:
	...
	DockEventFilter		*m_dockEventFilter;
...
private slots:
	...
	void setNumberOfReceivers(QObject *sender, int value, int last, const QList<bool> &list);
	...
	void addReceiver();
	void receiverDockVisibilityChanged(bool value);
	void receiverDockClosed(int rx);
...
class DockEventFilter : public QObject {
