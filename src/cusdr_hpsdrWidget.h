...
private:
	...
	//AeroButton	*ananPresenceBtn;
	AeroButton	*anan10PresenceBtn;
	AeroButton	*anan10EPresenceBtn;
	AeroButton	*anan100PresenceBtn;
	AeroButton	*anan100DPresenceBtn;
	AeroButton	*anan200DPresenceBtn;
...
private slots:
	...
	void setHardware();
	void disableAtlasModules();
	void enableAtlasModules();
