...
//		this,
//		SLOT(setMainVolume(QObject *, int, float)));
}
...
void DataEngine::setSampleRate(QObject *sender, int value) {
	...
	{	
		...
		if (RX.at(rx)->dttsp->getDttSPStatus()) {
			...
			RX.at(rx)->setDspMode(this, rx, mode);
			//setDspMode(this, rx, mode);
			//setAgcMode(this, rx, RX.at(rx)->getAGCMode());
...
//void DataEngine::setMainVolume(QObject *sender, int rx, float value) {
//
//	Q_UNUSED(sender)
//
//	DATA_ENGINE_DEBUG << "setMainVolume for RX " << rx;
//	RX[rx]->setAudioVolume(this, rx, value);
//}
...
//
//	io.mutex.lock();
//	RX.at(rx)->setFilterFrequencies(this, rx, low, high);
//	io.mutex.unlock();
//}
...
//	Q_UNUSED(sender)
//
//	RX.at(rx)->setAGCMode(this, rx, mode);
//
//}
...
//	Q_UNUSED(sender)
//
//	RX.at(rx)->setAGCGain(this, rx, value);
//}
