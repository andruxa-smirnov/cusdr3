...
//	tinyFontMetrics = new QFontMetrics(m_tinyFont);
//	m_fontHeightTinyFont = tinyFontMetrics->tightBoundingRect("M").height();
//	m_fonts.tinyFontMetrics = new QFontMetrics(m_fonts.tinyFont);
//	m_fontHeightTinyFont = m_fonts.tinyFontMetrics->tightBoundingRect("M").height();
...
//	smallFontMetrics = new QFontMetrics(m_smallFont);
//	m_fontHeightSmallFont = smallFontMetrics->tightBoundingRect("M").height();
//	m_fonts.smallFontMetrics = new QFontMetrics(m_fonts.smallFont);
	m_fontHeightSmallFont = m_fonts.smallFontMetrics->tightBoundingRect("M").height();
...
//	normalFontMetrics = new QFontMetrics(m_normalFont);
//	m_fontHeightNormalFont = normalFontMetrics->tightBoundingRect("M").height();
//	m_fonts.normalFontMetrics = new QFontMetrics(m_fonts.normalFont);
	m_fontHeightNormalFont = m_fonts.normalFontMetrics->tightBoundingRect("M").height();
...
//	freqFont1Metrics = new QFontMetrics(m_freqFont1);
//	m_fontHeightFreq1Font = freqFont1Metrics->tightBoundingRect("M").height();
//	m_fonts.freqFont1Metrics = new QFontMetrics(m_fonts.freqFont1);
	m_fontHeightFreq1Font = m_fonts.freqFont1Metrics->tightBoundingRect("M").height();
...
//	freqFont2Metrics = new QFontMetrics(m_freqFont2);
//	m_fontHeightFreq2Font = freqFont2Metrics->tightBoundingRect("M").height();
//	m_fonts.freqFont2Metrics = new QFontMetrics(m_fonts.freqFont2);
	m_fontHeightFreq2Font = m_fonts.freqFont2Metrics->tightBoundingRect("M").height();


//	m_bigFont1.setStyleStrategy(QFont::PreferAntialias);
//	//m_bigFont1.setStyleHint(QFont::SansSerif, QFont::PreferAntialias);
//	m_bigFont1.setBold(true);
//	m_bigFont1.setFixedPitch(true);
//	#ifdef Q_OS_MAC
//		m_bigFont1.setPixelSize(12);
//		m_bigFont1.setFamily("Arial");
//	#endif
//	#ifdef Q_OS_WIN
//		m_bigFont1.setPixelSize(12);
//		//m_bigFont1.setFamily("Arial");
...
//	bigFont1Metrics = new QFontMetrics(m_bigFont1);
//	m_fontHeightBig1Font = bigFont1Metrics->tightBoundingRect("M").height();
//	m_fonts.bigFont1Metrics = new QFontMetrics(m_fonts.bigFont1);
	m_fontHeightBig1Font = m_fonts.bigFont1Metrics->tightBoundingRect("M").height();
	m_fontHeightBig2Font = m_fonts.bigFont2Metrics->tightBoundingRect("M").height();


//	m_hugeFont.setStyleStrategy(QFont::PreferAntialias);
//	//m_hugeFont.setStyleHint(QFont::SansSerif, QFont::PreferAntialias);
//	m_hugeFont.setBold(true);
//	m_hugeFont.setFixedPitch(true);
//	#ifdef Q_OS_MAC
//		m_hugeFont.setPixelSize(72);
//		m_hugeFont.setFamily("Impact");
//	#endif
//	#ifdef Q_OS_WIN
//		m_hugeFont.setPixelSize(72);
//		m_hugeFont.setFamily("Impact");
...
//	hugeFontMetrics = new QFontMetrics(m_hugeFont);
//	m_fontHeightHugeFont = hugeFontMetrics->tightBoundingRect("M").height();
//	m_fonts.hugeFontMetrics = new QFontMetrics(m_fonts.hugeFont);
//	m_fontHeightHugeFont = m_fonts.hugeFontMetrics->tightBoundingRect("M").height();
...
//	m_oglTextBig1 = new OGLText(m_bigFont1);
//	m_oglTextHuge = new OGLText(m_hugeFont);
...
void QGLReceiverPanel::drawPanadapter() {
	...
	if (m_dataEngineState == QSDR::DataEngineUp) {
		...
		if (m_adcStatus == 2) {
			...
			//int rectWidth = hugeFontMetrics->boundingRect(str).width();
...
//		rectWidth = smallFontMetrics->boundingRect(fstr).width();
//		fontHeight = smallFontMetrics->tightBoundingRect("0").height() + spacing;
...
//		rectWidth = bigFont1Metrics->width(fstr);
//		fontHeight = bigFont1Metrics->tightBoundingRect("0").height() + spacing;
...
void QGLReceiverPanel::drawReceiverInfo() {
	...
	//int x1 = m_panRect.width() - (smallFontMetrics->tightBoundingRect(str).width() + 9);
	int x1 = m_panRect.width() - (m_fonts.smallFontMetrics->tightBoundingRect(str).width() + 9);
	int y1 = 3;

	//x1 -= smallFontMetrics->tightBoundingRect(str).width() + 7;
	//y1 = 3;

	//QRect rect = QRect(x1+2, y1, smallFontMetrics->tightBoundingRect(str).width() + 5, m_fontHeightSmallFont + 4);
	QRect rect = QRect(x1+2, y1, m_fonts.smallFontMetrics->tightBoundingRect(str).width() + 5, m_fontHeightSmallFont + 4);
	...
	//m_agcButtonRect = QRect(x1+2, y1, smallFontMetrics->tightBoundingRect(str).width() + 5, m_fontHeightSmallFont + 4);
	m_agcButtonRect = QRect(x1+2, y1, m_fonts.smallFontMetrics->tightBoundingRect(str).width() + 5, m_fontHeightSmallFont + 4);
	...
	if (m_panRect.height() > 15) {
		...
		//m_oglTextBig1->renderText(x+2, 22, 4.0f, str.arg(f1/1000).arg(f1 - 1000 * (int)(f1/1000), 3, 10, QLatin1Char('0')));
		...
		//m_oglTextBig1->renderText(x, 20, 5.0f, str.arg(f1/1000).arg(f1 - 1000 * (int)(f1/1000), 3, 10, QLatin1Char('0')));
