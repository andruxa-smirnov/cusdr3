...
//	QFontMetrics *hugeFontMetrics;
	...
	int			m_adcStatus;
	int			m_fps;
	int			m_fontHeightTinyFont;
	int			m_fontHeightSmallFont;
	int			m_fontHeightNormalFont;
	int			m_fontHeightFreq1Font;
	int			m_fontHeightFreq2Font;
	int			m_fontHeightBig1Font;
	int			m_fontHeightBig2Font;
	int			m_fontHeightHugeFont;
