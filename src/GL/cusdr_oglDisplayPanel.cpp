...
void OGLDisplayPanel::setupConnections() {
	...
	CHECKED_CONNECT(
		...
		this, 
		SLOT(setReceivers(QObject *, int, int, const QList<bool> &)));
...
void OGLDisplayPanel::setupTextstrings() {
	...
	m_anan10String = QString("Anan 10 ");
	m_anan10StringWidth = m_oglTextSmall->fontMetrics().width(m_anan10String);

	m_anan10EString = QString("Anan 10E ");
	m_anan10EStringWidth = m_oglTextSmall->fontMetrics().width(m_anan10EString);

	m_anan100String = QString("Anan 100 ");
	m_anan100StringWidth = m_oglTextSmall->fontMetrics().width(m_anan100String);

	m_anan100DString = QString("Anan 100D ");
	m_anan100DStringWidth = m_oglTextSmall->fontMetrics().width(m_anan100DString);

	m_anan200DString = QString("Anan 200D ");
	m_anan200DStringWidth = m_oglTextSmall->fontMetrics().width(m_anan200DString);
...
//	m_oglTextSmallItalic->renderText(m_syncWidth + m_adcWidth + m_sendIQWidth + 29, y1 + m_upperRectY, m_recvAudioString);
	...
	// Model status
	QSDR::_SDRModel	model = set->getModel();
	int modelStringWidth;
	...
	case 1: // Atlas
		...
		// Metis
		str = m_metisString;
		modelStringWidth = m_metisStringWidth;
		...
		if (set->getPenelopePresence()) {
			...
			str = m_penelopeString;
			modelStringWidth = m_penelopeStringWidth;
			...
			modelStringWidth = m_pennylaneStringWidth;
	...
	case 2: // Anan 10 (Hermes)

		str = m_anan10String;
		modelStringWidth = m_anan10StringWidth;

		if (m_dataEngineState == QSDR::DataEngineUp) {

			rect = QRect(x1, y1, m_anan10StringWidth + m_versionStringWidth, m_blankHeight);
		}
		else {

			rect = QRect(x1, y1, m_anan10StringWidth, m_blankHeight);
		}
		break;
	...
	case 3: // Anan 10E
		...
		str = m_anan10EString;
		modelStringWidth = m_anan10EStringWidth;

		if (m_dataEngineState == QSDR::DataEngineUp) {

			rect = QRect(x1, y1, m_anan10EStringWidth + m_versionStringWidth, m_blankHeight);
		}
		else {

			rect = QRect(x1, y1, m_anan10EStringWidth, m_blankHeight);
		}
		break;
	...
	case 4: // Anan 100
		...
		str = m_anan100String;
		modelStringWidth = m_anan100StringWidth;

		if (m_dataEngineState == QSDR::DataEngineUp) {

			rect = QRect(x1, y1, m_anan100StringWidth + m_versionStringWidth, m_blankHeight);
		}
		else {

			rect = QRect(x1, y1, m_anan100StringWidth, m_blankHeight);
		}
		break;

	case 5: // Anan 100D

		str = m_anan100DString;
		modelStringWidth = m_anan100DStringWidth;

		if (m_dataEngineState == QSDR::DataEngineUp) {

			rect = QRect(x1, y1, m_anan100DStringWidth + m_versionStringWidth, m_blankHeight);
		}
		else {

			rect = QRect(x1, y1, m_anan100DStringWidth, m_blankHeight);
		}
		break;

	case 6: // Anan 200D

		str = m_anan200DString;
		modelStringWidth = m_anan200DStringWidth;

		if (m_dataEngineState == QSDR::DataEngineUp) {

			rect = QRect(x1, y1, m_anan200DStringWidth + m_versionStringWidth, m_blankHeight);
		}
		else {

			rect = QRect(x1, y1, m_anan200DStringWidth, m_blankHeight);
		}
		break;
	} // switch(model)
	...
	if (m_dataEngineState == QSDR::DataEngineUp)
		x1 += modelStringWidth + m_versionStringWidth + m_blankWidth;
	else
		x1 += modelStringWidth + m_blankWidth;
...
void OGLDisplayPanel::setReceivers(QObject *sender, int value, int last, const QList<bool>& list) {
