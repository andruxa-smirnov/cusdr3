...
private:
	...
	QString		m_anan10String;
	QString		m_anan10EString;
	QString		m_anan100String;
	QString		m_anan100DString;
	QString		m_anan200DString;
	...
	int		m_anan10StringWidth;
	int		m_anan10EStringWidth;
	int		m_anan100StringWidth;
	int		m_anan100DStringWidth;
	int		m_anan200DStringWidth;
	int		m_AttnWidth;
	int		m_ditherWidth;
	int		m_randomWidth;
...
private slots:
	...
	void	setReceivers(QObject *sender, int value, int last, const QList<bool>& list);
